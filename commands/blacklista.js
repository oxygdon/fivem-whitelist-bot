...
//////////////////////////////////////////////////////////////////////////////////// nie tykaj
            ...
            await rMember.roles.add(role.id).catch(e => message.lineReplyNoMention("bot nie posiada permisji")) // nie trzeba tlumaczyc
            ...
            console.log(`------------------------------------------------------------\n[LOG] ${message.author.tag} zblacklistował ${rMember.id}\n------------------------------------------------------------`) // log
